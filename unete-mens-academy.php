        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-10 heading-section text-center ftco-animate">
                    ...
                    <p class="mb-5 text-10">Todas las solicitudes enviadas a MEN’S Academy a través de www.mensacademy.com o por correo electrónico están de acuerdo con los Términos y Condiciones de MEN’S Academy. Para recibir una copia de nuestros Términos y condiciones, comuníquese con info@mensacademy.com</p>
                </div>
            </div>
            <div class="row justify-content-center">
                    ...
                    <form class="appointment-form">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="d-me-flex">
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="Nombre y número de la casa*">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="d-me-flex">
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-sm">
                                            <input onkeyup="goToMonth();" class="form-control" maxlength="2" type="text" id="day" name="day" placeholder="Día">
                                            </div>
                                            <div class="col-sm">
                                            <input onkeyup="goToYear();" class="form-control" maxlength="2" type="text" id="month" name="month" placeholder="Mes">
                                            </div>
                                            <div class="col-sm">
                                            <input maxlength="4" class="form-control" type="text" id="year" name="year" placeholder="Año">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="d-me-flex">
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="Tamaño del vestido / Tamaño del traje*">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="d-me-flex">
                                    <div class="form-group">
                                        <select name="eyes" id="eyes" class="form-control">
                                            ...
                                            <option>Azul</option>
                                            <option>Azul con verde</option>
                                            <option>Azul con gris</option>
                                            <option>Gris</option>
                                            <option>Café</option>
                                            <option>Negro</option>
                                            <option>Hazel</option>
                                            <option>Verde</option>
                                            <option>Verde con gris</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="d-me-flex">
                                    <div class="form-group">
                                        <select name="hair" id="hair" class="form-control"> <option value="" _istranslated="1">Color del cabello*</option>
                                        <option _istranslated="1">Auburn</option>
                                        <option _istranslated="1">Rubio</option>
                                        <option _istranslated="1">Oscuro rubio</option>
                                        <option _istranslated="1">rubio</option>
                                        <option _istranslated="1">Venitian rubio</option>
                                        <option _istranslated="1">Marrón</option>
                                        <option _istranslated="1">Claro marrón</option>
                                        <option _istranslated="1">oscuro</option>
                                        <option _istranslated="1">negro</option>
                                        <option _istranslated="1">blanco</option>
                                        <option _istranslated="1">calvo</option>
                                        <option _istranslated="1">gris</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="d-me-flex">
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="Talla del calzado*">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="d-me-flex">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="por ejemplo, instagram.com/mensagency">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="d-me-flex">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="por ejemplo, facebook.com/mensagency">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="d-me-flex">
                                    <div class="form-group">
                                        <label>Twitter</label>
                                        <input type="text" class="form-control" placeholder="por ejemplo, twitter.com/mensagency">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="d-me-flex">
                                    <div class="form-group">
                                        <label>YouTube</label>
                                        <input type="text" class="form-control" placeholder="por ejemplo, youtube.com/mensagency">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="d-me-flex">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="por ejemplo, https://mensagency.com*">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="d-me-flex">
                                    <div class="form-group">
                                        <label>¿Eres miembro de Spotlight?</label>
                                        <select name="spotlight" id="spotlight" class="form-control">
                                            <option value="">seleccione</option>
                                            <option _istranslated="1">Sí</option>
                                            <option _istranslated="1">No</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="d-flex justify-content-center">
                                    <input type="checkbox" name="agreement" id="agreement"><label class="field_label" for="agreement"> Podemos compartir su información con otras agencias modelo y organizaciones profesionales asociadas.</label>
                                </div>
                            </div>
